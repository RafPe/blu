...
namespace BluApi.Common
{
    public class OpenSSL
    {
        ...
        public string OpenSSLDecrypt(string encrypted, string passphrase)
        {
            ...
            string encodedString = DecryptStringFromBytesAes(encryptedBytes, key, iv);
        ...
        public static string DecryptStringFromBytesAes(byte[] cipherText, byte[] key, byte[] iv)
        {
            ...
            try
            {
                // Create a RijndaelManaged object
                // with the specified key and IV.
                aesAlg = new RijndaelManaged { Mode = CipherMode.CBC, KeySize = 256, BlockSize = 256, Key = key, IV = iv };
                aesAlg.Padding = PaddingMode.None;
